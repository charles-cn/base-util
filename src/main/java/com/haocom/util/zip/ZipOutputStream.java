...
class ZipOutputStream extends FilterOutputStream {
     ...
     * @since 1.1
     */
    private Map<ZipEntry, byte[]> offsets = new ConcurrentHashMap<ZipEntry, byte[]>();
    ...
    protected static byte[] toDosTime(long t) {
        ...
        long value = ((year - 1980) << 25) | (month << 21) | (calendar.get(Calendar.DAY_OF_MONTH) << 16) | (calendar.get(Calendar.HOUR_OF_DAY) << 11)
